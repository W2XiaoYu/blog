...
Flutter 写久以后，真正费时间的往往不是组件本身，而是打包、原生交互、桌面窗口和性能问题。这里把这些零散经验按场景收在一起。

- [打包构建](./flutter/packaging) — 渠道打包、运行、生成 App 图标
- [安卓原生](./flutter/android-native) — 获取 OAID、连续两次返回退出应用等原生交互
...
- [代码片段](./flutter/code-snippets) — 日志、网络检测、视频流、解压乱码、文件分片上传等
